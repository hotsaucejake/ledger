...
Ledger stores four kinds of things:
...
Templates are reusable defaults for creating entries. They live **inside the encrypted ledger**
so templates can be shared across machines as long as the ledger file is shared.
...
Templates provide reusable defaults for entry creation. They are stored inside the ledger
