...
Jot is a **Rust workspace** producing a single CLI binary (with optional migration tool).
...
│   │       ├── output/
│   │       └── args.rs
│   └── jot-migrate/         # Deferred to Phase 1.0
│       └── ...
└── tests/
    └── integration/
```
...
* [ ] Create new jot with passphrase
* [ ] Open existing jot
...
* [ ] Jot builds on macOS and Linux without special setup
